                ...
                <div className='backdrop-blur-md w-fit h-fit p-10 rounded-2xl'>
                    ...
                    <div className='flex flex-col justify-center  items-center gap-5 mt-10'>
                        ...
                        <div className='flex items-center justify-center gap-3'>
                            <label for="email" className='text-xl font-bold text-black'>Your Name :</label>
                            <input type="text" className='w-xs h-10 bg-white rounded-full border-x-2 p-2' />
                        </div>
                        ...
                        <button className='w-xs h-14 hover:bg-cyan-900 border-4 border-y-0 border-cyan-950 bg-white text-cyan-950 hover:text-white hover:border-0 text-2xl font-extrabold rounded-full mt-3 flex flex-col items-center justify-center'>Sign Up</button>
                    </div>
